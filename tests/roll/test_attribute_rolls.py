...
from src.character.character import CharacterStats
from src.roll.attribute_rolls import StrRoll, DexRoll, ConRoll, IntRoll, WisRoll, ChaRoll


@pytest.mark.parametrize("cls,expected_roll", [
